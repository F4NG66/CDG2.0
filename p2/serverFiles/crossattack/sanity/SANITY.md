...
|---|---|---|---|---|
| 1 | Label permutation (n=50) | null AUC ≈ 0.50, true ≫ null | transfer-null 0.502 (max 0.833), within-null 0.500; true = 1.000 | **PASS** |
...
| 4 | Noise / shuffled-state | ≈ 0.50 | gaussian |Δ|≤0.064, row-shuffle |Δ|≤0.032, gaussian-transfer |Δ|≤0.020 from 0.50 | **PASS** |
...
|---|---|---|---|---|---|---|
| hidden/L11 | 0.497±0.153 | 0.450 | 0.532 | 1.000 | 1.000 | 0 |
| hidden/L16 | 0.513±0.129 | 0.436 | 0.473 | 1.000 | 1.000 | 0 |
| hidden/L26 | 0.499±0.120 | 0.498 | 0.495 | 1.000 | 0.999 | 0 |
| sae/L11 | 0.499±0.051 | 0.539 | 0.503 | 1.000 | 0.991 | 0 |
| sae/L16 | 0.513±0.048 | 0.493 | 0.471 | 1.000 | 0.974 | 0 |
| sae/L26 | 0.494±0.047 | 0.501 | 0.482 | 0.994 | 0.938 | 0 |
