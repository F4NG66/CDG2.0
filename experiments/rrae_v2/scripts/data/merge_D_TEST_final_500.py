...
SUMMARY_PATH = (
    ...
    / "data/TEST_HELDOUT_V1/source_audits/"
      "D_TEST_BENIGN_CLEAN_FINAL_500_summary.json"
)
...
if label_counts != Counter({"benign": 500}):
    raise RuntimeError(
        f"Unexpected labels: {label_counts}"
    )

if bucket_counts != Counter({"D": 500}):
    raise RuntimeError(
